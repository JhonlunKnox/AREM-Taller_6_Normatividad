...
Sobre cómo representa las necesidades del cliente, el hallazgo central del diagnóstico coincide con lo que ya habíamos visto en el modelado STRIDE del Taller 5: el riesgo dominante no es un atacante externo sino la degradación interna del dato por edición manual. Las tres brechas de riesgo Alto (exportaciones sin control, permisos de edición amplios para los cuatro agentes y ausencia de llave única para conciliar) describen el mismo problema desde ángulos distintos. Estas brechas podrían mitigarse mediante funcionalidades disponibles dentro del ecosistema Microsoft 365, como controles de acceso, auditoría y prevención de pérdida de datos, sujeto a verificar que el licenciamiento institucional contratado incluya las funcionalidades requeridas. Eso importa porque la restricción dura del cliente es precisamente esa: cualquier software externo pasa a revisión de comité, y ya existe el antecedente de un desarrollo previo que nunca llegó a producción.

Los supuestos que tomamos fueron tres. Primero, que existen controles institucionales de seguridad como políticas, autenticación multifactor y cifrado dentro del entorno Microsoft 365 de la Universidad; sin embargo, debe verificarse su aplicación específica sobre el directorio analizado antes de considerarlos evidencia suficiente de cumplimiento. Segundo, que la Universidad se encuentra dentro del ámbito de aplicación del Registro Nacional de Bases de Datos (RNBD), ya que el Decreto 090 de 2018 establece esta obligación para las sociedades y entidades sin ánimo de lucro con activos totales superiores a 100.000 UVT. La Universidad reportó activos por $883.688 millones al cierre de 2025, por lo que supera ampliamente este umbral. En consecuencia, la verificación pendiente consiste en determinar si este directorio se encuentra incluido dentro de las bases de datos registradas ante la SIC, aspecto que debe confirmarse con la Dirección Jurídica. Tercero, que existe una relación laboral entre los titulares y la Universidad y una política institucional de tratamiento de datos personales; sin embargo, debe verificarse que para este directorio exista evidencia de la autorización del titular cuando sea exigible o que el tratamiento se encuentre amparado por una excepción legal aplicable. Por ello, además del deber de información y de contar con canales para ejercer los derechos de los titulares, debe mantenerse evidencia que permita demostrar la legitimidad del tratamiento.
