...
Para el paso 2 reutilizamos las categorías del caso base (consentimiento, seguridad, protección de datos, prevención de fugas, retención, roles) y agregamos dos propias del cliente: calidad del dato, porque el principio de calidad del artículo 4 de la Ley 1581 es justamente donde este sistema falla, y transferencia internacional, porque el archivo vive en la nube de un proveedor con infraestructura fuera del país.
...
En cuanto a la nube, el artículo 26 de la Ley 1581 prohíbe transferir datos personales a países que no ofrezcan un nivel adecuado de protección. La SIC, mediante la Circular Externa 005 del 10 de agosto de 2017, fijó los criterios para determinar ese nivel y publicó una lista de países que lo cumplen, entre ellos Estados Unidos, Reino Unido, Perú, México y los miembros de la Unión Europea. Eso resuelve el ítem 17 a favor del cliente, pero bajo el principio de responsabilidad demostrada el responsable debe poder probar que implementó medidas apropiadas y efectivas sobre los datos que transfiere, lo que refuerza las recomendaciones de auditoría, etiquetado y DLP. Del lado técnico usamos ISO/IEC 27001:2022 como referencia de controles, sobre todo control de accesos, registro de eventos y clasificación de la información, y complementamos con la documentación de Microsoft Purview para verificar que las correcciones propuestas son ejecutables dentro del tenant actual.
